...
#define MBX_DS_STRNAME		"MBX_DS"	// Nome della mailbox tra controller e ds
#define MBX_LOG_STRNAME		"MBX_LG"	// Nome della mailbox tra diag e logger

// Nomi per l'allocazione delle aree di memoria condivise degli status 
#define	STATUS_SHM_1		"STAT_A"
#define	STATUS_SHM_2		"STAT_B"
#define	STATUS_SHM_3		"STAT_C"

// Codici di stato per un filter
#define FILTER_OK			0
